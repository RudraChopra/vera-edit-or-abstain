...
This sweep compares VERA against INLP, LEACE, RLACE, R-LACE, TaCo, SPLINCE,
SPLICE, MANCE, MANCE++, and domain generalization methods.

## Current Defensible Contribution Sentence

VERA introduces a certified frontier-aware edit-or-abstain decision layer for
...
ways to remove or reduce encoded concept information. VERA defines when an edit
...
shift. VERA audits representation edits after source labels are known. The
