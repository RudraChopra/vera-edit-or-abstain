...
condition, the certified safe set is empty, so the deterministic VERA rule
...
matched VERA receipts are added.
...
VERA may claim full official-code MANCE++ evidence on Waterbirds. It must not
