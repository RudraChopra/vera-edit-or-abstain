# FARO Reviewer Packet

## What A Reviewer Should Believe

FARO is a decision protocol for representation editing. Its primary novelty is
...
The strongest attack is that FARO is a wrapper around erasers. The response is
...
The second attack is that Waterbirds is not a FARO win. The response is to say
