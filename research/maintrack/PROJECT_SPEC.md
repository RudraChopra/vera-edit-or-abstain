...
VERA is a certified edit-or-abstain protocol for representation interventions
...
defensible: given a family of candidate representation edits, VERA selects only
...
The paper may claim that VERA is a protocol for safe edit selection and
