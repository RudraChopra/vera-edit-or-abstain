...
def download_acs(destination: Path) -> None:
    try:
    ...
    source.get_data(states=["CA", "TX"], download=True)


def main() -> None:
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--dataset", required=True, choices=("camelyon17_wilds", "civilcomments_wilds", "acs_income_ca_tx"))
