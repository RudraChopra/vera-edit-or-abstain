...
Paper A is the VERA method paper. Science-fair framing is out of scope.

## Locked Thesis

VERA converts representation erasure from "apply an edit and hope the target
...
VERA is an edit-or-abstain protocol for representation interventions that is
orthogonal to INLP, LEACE, RLACE, TaCo, SPLINCE, and MANCE++: those methods
construct candidate edits, while VERA certifies whether any candidate edit is
