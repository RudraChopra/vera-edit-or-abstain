...
| --- | --- | --- | ---: | --- | ---: |
| waterbirds | VERA_selected minus group_reweighted_erm | `external_target_balanced_accuracy` | -0.067316 | +0/-5 of n=5 | 0.062500 |
| waterbirds | VERA_selected minus group_reweighted_erm | `external_worst_target_source_accuracy` | -0.195261 | +0/-5 of n=5 | 0.062500 |
| waterbirds | VERA_selected minus group_reweighted_erm | `external_source_leakage_balanced_accuracy` | 0.000000 | +3/-2 of n=5 | 1.000000 |
| camelyon17 | VERA_selected minus group_dro_probe | `external_target_balanced_accuracy` | 0.011499 | +5/-0 of n=5 | 0.062500 |
| camelyon17 | VERA_selected minus group_dro_probe | `external_worst_target_source_accuracy` | 0.028829 | +5/-0 of n=5 | 0.062500 |
| camelyon17 | VERA_selected minus group_dro_probe | `validation_source_leakage_balanced_accuracy` | 0.000000 | +0/-0 of n=0 |  |
