...
| pass | `faro_selected_frontier_point` | method_under_test | VERA selected point and abstention decision are reported separately from baselines. |
...
| pass | `no_sota_erasure_claim` | claim_boundary | Evidence supports VERA as certified selection/abstention, not universal SOTA erasure. |
